...
public class EmployeeAllDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_all_details);
    ...
    public void prepairData() {
        ...
        recyclerView.setAdapter(new AllDetilsAdapter(this, recyclerView, refList));
    }
